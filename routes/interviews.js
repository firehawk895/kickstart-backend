    ...
    kew.all([db.get('vacancies', interviewPayload.vacancyId), db.get('jobseekers', interviewPayload.jobseekerId)])
        ...
        .then(function(results) {
            ...
            var message = "An interview has been scheduled for " +
                    ...
                    ". Time : " + customUtils.getFormattedDate(parseFloat(theResults[0].interviewTime)/1000)
        ...
        .then(function(results) {
            ...
            var message =
                ...
                "status : " + finalPayload.status +
                 ", time : " + customUtils.getFormattedDate(parseFloat(finalPayload.interviewTime)/1000)
